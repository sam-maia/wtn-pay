...
const ConcluidoEn = ({ logo, setNavegacao }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center w-full max-w-md mx-auto px-4 gap-8 pb-20 text-center bg-cinzaPadao text-zinc-600 font-sans">
      ...
      <button onClick={() => navegar("/ep")} className="px-6 py-3 rounded-2xl text-white text-lg md:text-xl font-bold bg-zinc-600 hover:bg-zinc-700 transition">Conclude</button>
    </div>
  )
}
