const ConcluidoEp = (props) => {
    return(
        <div className="flex flex-col items-center justify-center w-full h-full max-w-md mx-auto px-4 py-10 gap-8 text-center bg-cinzaPadao text-zinc-600 font-sans">
            ...
            <button onClick={() => props.setNavegacao('inicio')} className="px-6 py-3 rounded-2xl text-white text-lg md:text-xl font-bold bg-zinc-600 hover:bg-zinc-700 transition">Concluir</button>
        </div>
    )
}
